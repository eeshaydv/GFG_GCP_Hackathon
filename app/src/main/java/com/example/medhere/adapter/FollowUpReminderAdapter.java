...
public class FollowUpReminderAdapter extends RecyclerView.Adapter<FollowUpReminderAdapter.HolderCallHistory>{
    ...
    public FollowUpReminderAdapter(Context context, ArrayList<FollowUpReminder> followUpReminders) {
    ...
    @NonNull
    @Override
    public FollowUpReminderAdapter.HolderCallHistory onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.follow_ups_item_view, parent, false);

        return new FollowUpReminderAdapter.HolderCallHistory(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FollowUpReminderAdapter.HolderCallHistory holder, int position) {
